...
<div>
  <div class="w">
    <div id="logo">
        <a href="#">
            <img src="/static/img/logo.png" alt="VUE" width="170" height="60">
        </a>
        <b></b>
    </div>
    </div>
            ...
            <div class="login-form"><div class="tips-wrapper"><div class="tips-inner"><div class="cont-wrapper"><i class="icon-tips"></i><p>京东不会以任何理由要求您转账汇款，谨防诈骗。</p></div></div></div>
                        ...
                        <div class="form">
                            <form id="formlogin" method="post" onsubmit="return false;">
                                ...
                                <div class="item item-fore1">
                                    ...
                                    <input id="loginname" type="text" class="itxt" name="loginname" tabindex="1" autocomplete="off" value="" placeholder="邮箱/用户名/登录手机">
                                ...
                                <div id="o-authcode" class="item item-vcode item-fore3  hide ">
                                    ...
                                    <img id="JD_Verification1" class="verify-code" clstag="pageclick|keycount|login_pc_201804112|14" src2="//authcode.jd.com/verify/image?srcid=passport&amp;a=1&amp;acid=74ab10dd-d98f-426d-8935-7957a31b0a9f&amp;uid=74ab10dd-d98f-426d-8935-7957a31b0a9f" onclick="this.src= document.location.protocol +'//authcode.jd.com/verify/image?srcid=passport&amp;a=1&amp;acid=74ab10dd-d98f-426d-8935-7957a31b0a9f&amp;uid=74ab10dd-d98f-426d-8935-7957a31b0a9f&amp;yys='+new Date().getTime();$('#authcode').val('');">
                ...
                <div class="qrcode-login" style="display: none; visibility: visible;">
                    <div class="mc">
                        ...
                        <div class="qrcode-main">
                            <div class="qrcode-img" style="left: 64px;">
                                <img src="//qr.m.jd.com/show?appid=133&amp;size=147&amp;t=1577777792885" alt=""><div class="qrcode-error02 hide" id="J-qrcoderror">							<a href="#none">								<span class="error-icon"></span>								<div class="txt">网络开小差咯<span class="ml10">刷新二维码</span></div>							</a>						</div>
                            </div>
                    ...
                    <ul>
                            ...
                            <li class="extra-r">
                            <div>
                            <div class="regist-link"><a href="//reg.jd.com/p/regPage" clstag="pageclick|keycount|login_pc_201804112|5" target="_blank"><b></b>立即注册</a></div>
                            </div>
                        </li>
                    </ul>
                </div>            </div>
        </div>
        <div class="login-banner" style="background-color: #28000d">		              <div class="w">			         <div id="banner-bg" clstag="pageclick|keycount|20150112ABD|46" class="i-inner" style="background: url(//img11.360buyimg.com/da/jfs/t1/98425/7/8419/43310/5e048895Ea85c6dc9/fcfd79817b838bcc.jpg) 0px 0px no-repeat;background-color: #28000d"></div>		              </div>		           </div>
    </div>
</div>
    <div class="w">
    <div id="footer-2013">
...
.pi {
  ...
  height: 40px;
  padding: 12px 0 0;
  background-image: url(//misc.360buyimg.com/product/skin/2013/i/20130330C.png);
...
img.err-poster,
img.err-product {
  background: url(//misc.360buyimg.com/lib/skin/e/i/error-jd.gif) no-repeat 50%
    50%;
}
img.err-price {
  width: 81px;
  height: 22px;
  background: url(//misc.360buyimg.com/lib/skin/e/i/error-3.gif) no-repeat 50%
    50%;
}
.loading-style1 b,
.loading-style2 {
  background: url(//misc.360buyimg.com/lib/skin/e/i/loading-jd.gif) no-repeat
    50% 50%;
}
.loading-style1 {
  width: 126px;
...
.thickclose {
  ...
  width: 13px;
  height: 13px;
  background: url(//misc.360buyimg.com/jdf/1.0.0/ui/dialog/1.0.0/dialog.png)
    no-repeat;
  font-size: 0;
}
.thickcon {
...
.thickloading {
  background: url(//misc.360buyimg.com/lib/skin/e/i/loading-jd.gif) #fff
...
.compare .extra {
  ...
  width: 13px;
  height: 13px;
  background: url(//misc.360buyimg.com/201007/skin/df/i/bg_hotsale.gif)
...
.iloading {
  ...
  height: 30px;
  padding-left: 22px;
  background: url(//misc.360buyimg.com/201007/skin/df/i/loading.gif) no-repeat 0
    center;
  margin: 0 auto;
  line-height: 30px;
  color: #999;
...
.model-prompt .con b {
  position: absolute;
  background-image: url(//misc.360buyimg.com/201007/skin/df/i/bg_prompt.gif);
  background-repeat: no-repeat;
}
#model-collect .con {
...
#shortcut-2013 .fl b {
  ...
  width: 13px;
  height: 13px;
  background: url(//misc.360buyimg.com/lib/skin/2013/i/20130725.png) no-repeat 0
    0;
  cursor: pointer;
}
...
#logo-2013 a:hover b {
  display: none;
  background: url(//misc.360buyimg.com/lib/skin/2013/i/20130330A_2.png) #fff
    no-repeat 0 -312px;
}
.root61 #logo {
  width: 350px;
...
#shelper-2013 .list-text .resultful {
  background-image: url(//misc.360buyimg.com/lib/skin/2012/i/8.png);
  background-repeat: no-repeat;
...
#shelper-2013 .list-word a:link,
#shelper-2013 .list-word a:visited {
  float: left;
  white-space: nowrap;
  margin-right: 16px;
  color: #005ea7;
...
#my360buy-2013 .orderlist .more {
  width: 50px;
  height: 50px;
  background: url(//misc.360buyimg.com/lib/skin/2013/i/20130330A_2.png)
    no-repeat 0 -250px;
  overflow: hidden;
  line-height: 150px;
  margin-right: 0;
...
#categorys-2013 .categorys-links a {
  ...
  width: 194px;
  height: 30px;
  background-image: url(//misc.360buyimg.com/lib/skin/2013/i/28.png);
  background-repeat: no-repeat;
  line-height: 80px;
  overflow: hidden;
}
...
#categorys-2013 .title-list li {
  ...
  line-height: 28px;
  margin-right: 20px;
  background-image: url(//misc.360buyimg.com/lib/skin/2013/i/virtuals-cat-ico20140826.png);
  background-repeat: no-repeat;
}
...
.footmark .may-like .change .ico {
  ...
  height: 16px;
  margin-right: 5px;
  background: url(//misc.360buyimg.com/product/skin/2012/i/update.png) no-repeat;
}
...
#shortcut-2013 #app-jd.hover .blank,
#shortcut-2013 #app-jd.hover .outline {
  width: 98px;
}
#app-jd .dd {
  padding-top: 60px;
...
#app-jd .qr-info {
  ...
  width: 237px;
  height: 65px;
  background: url(//img13.360buyimg.com/da/jfs/t1222/40/385367657/3256/5f15549b/551cf5f5Na7476cd5.png);
}
...
#jd-vip i {
  ...
  height: 11px;
  overflow: hidden;
  background: url(//misc.360buyimg.com/lib/skin/2013/i/vip.png);
}
...
#shortcut-2013 #jd-dakehu i {
  ...
  height: 11px;
  display: block;
  background: url(//img14.360buyimg.com/da/jfs/t580/111/484703678/1790/f7b8269f/546bfdd4N00e36964.jpg)
    0 0 no-repeat;
}
...
div#login-dialog .ui-dialog-close {
  ...
  line-height: 14px;
  top: 13px;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/css/i/pwd-icons.png)
    0 -143px;
}
.tip-box {
  width: 400px;
...
.icon-box .m-icon {
  ...
  *zoom: 1;
  ...
  width: 48px;
  height: 48px;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/css/i/icon48.png)
    no-repeat;
}
.icon-box .succ-icon {
  background-position: 0 0;
...
.form .item-fore2 .clear-btn {
  ...
  width: 14px;
  height: 14px;
  /* background: url(/static/img/css-img-1.png) -25px -143px
    no-repeat; */
  cursor: pointer;
  display: none;
}
...
.form .item-fore2 .capslock {
  ...
  line-height: 28px;
  overflow: hidden;
  /* background: url(//misc.360buyimg.com/user/passport/1.0.0/css/i/capslock.png)
    no-repeat; */
}
...
.form .item-fore2 .capslock b {
  ...
  height: 14px;
  overflow: hidden;
  /* background: url(/static/img/css-img-1.png) -104px -133px
    no-repeat; */
}
...
.login-form .btn-2qrcode {
  ...
  bottom: 0;
  overflow: hidden;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/widget/login-form-2018-0827/i/login-qricon-01.png)
    no-repeat;
...
.login-form .qrcode-login .qrcode-img .qrcode-error02 .error-icon {
  ...
  width: 50px;
  height: 50px;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/css/i/qr-error-icon.png)
    no-repeat;
}
...
.login-form .qrcode-login .qrcode-help {
  ...
  width: 141px;
  height: 168px;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/css/i/phone-orange.png)
    no-repeat;
  z-index: 99;
}
...
.login-form .qrcode-login .qrcode-succ .succ-icon {
  ...
  height: 71px;
  margin: 0 auto;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/css/i/qrcode-succ-2016.png)
    no-repeat;
}
...
.login-form .qlogin-main .qlogin-tit .qq-icon {
  ...
  *zoom: 1;
  ...
  overflow: hidden;
  vertical-align: middle;
  background: url(/static/img/css-img-1.png) -104px -157px;
  margin-right: 10px;
}
...
.login-form .qlogin-main .u-pic .mask {
  ...
  top: 0;
  z-index: 2;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/widget/login-form-2018-0827/i/upic-bg.png)
    no-repeat;
}
...
.qr-coagent li b {
  ...
  height: 25px;
  display: block;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/widget/login-form-2018-0827/i/qr-coagent.png)
    no-repeat;
  margin: 0 auto;
  position: absolute;
  left: 0;
...
#country_code_layer .close-button {
  ...
  top: 5px;
  position: absolute;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/widget/foreign-number-layer-170524/i/close-button.png)
    no-repeat;
  width: 17px;
  height: 17px;
}
#country_code_layer .arrow {
  display: block;
  position: absolute;
  background-image: url(//misc.360buyimg.com/user/passport/1.0.0/widget/foreign-number-layer-170524/i/tips.gif);
  background-repeat: no-repeat;
  width: 16px;
  height: 9px;
  background-position: 0 0;
...
#country_code_layer .search-bar .search-icon {
  ...
  width: 17px;
  height: 16px;
  background: url(//misc.360buyimg.com/user/passport/1.0.0/css/i/search-icon.png)
    no-repeat;
  position: absolute;
  left: 17px;
  top: 13px;
